...
class Widget_Google(QFrame):#  谷歌账号界面
    def __init__(self, text: str, parent=None,configurator=None,user_interface_prompter=None,background_executor=None):
        ...
        self.comboBox_account_type.addItems(['Free Account',  'Paid Account'])
    ...
    def test_request(self):
        ...
        if self.background_executor.Request_test_switch(self):
            ...
            #创建子线程
            thread = self.background_executor("Interface Testing","","","Google",Base_url,Model_Type,API_key_str,Proxy_port)
            thread.start()